class Company:
    def __init__(self, CBB_current, CBB_previous, Noncurrent_BB_current, Noncurrent_BB_previous,
        ...
        self.shariah_status_previous  
        self.shariah_status_current 
        #self.Non_shariah20_percentage_current = (Non_shariah20_revenue_current / self.Revenue_current) * 100
        #self.Non_shariah20_percentage_previous = (Non_shariah20_revenue_previous / self.Revenue_previous) * 100
        #self.Non_shariah5_percentage_current = (Non_shariah5_revenue_current / self.Revenue_current) * 100
        #self.Non_shariah5_percentage_previous = (Non_shariah5_revenue_previous / self.Revenue_previous) * 100